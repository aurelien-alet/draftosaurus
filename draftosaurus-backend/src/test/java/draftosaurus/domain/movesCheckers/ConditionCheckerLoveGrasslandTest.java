...
public class ConditionCheckerLoveGrasslandTest extends TestCase {

    public ConditionCheckerLoveGrasslandTest( String testName ) {
        super( testName );
    }

    public static Test suite() {
        return new TestSuite( ConditionCheckerLoveGrasslandTest.class );
    }

    public void testEmptyLoveGrasslandPadockShouldAcceptAnyDinosaure() {
        ConditionCheckerLoveGrassland conditionChecker = 
            instanciateEmptyConditionCheckerLoveGrassland();
    ...
    public void testNotEmptyLoveGrasslandPadockShouldAcceptAnyDinosaure() {
        ConditionCheckerLoveGrassland conditionChecker = 
        instanciateDinosaureConditionCheckerLoveGrassland();
    ...
    private static ConditionCheckerLoveGrassland instanciateEmptyConditionCheckerLoveGrassland(){
        PaddockAssignements paddockAssignementsMock = BoardMock.instanciatePaddockAssignementsMock();
        return new ConditionCheckerLoveGrassland(paddockAssignementsMock);
    }

    private static ConditionCheckerLoveGrassland 
    instanciateDinosaureConditionCheckerLoveGrassland(){
